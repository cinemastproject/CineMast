...
public class PopularShowsFragment extends Fragment implements FetchFromServerUser {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.popular_shows, container, false);
        new FetchFromServerTask(this, 0).execute("https://api.themoviedb.org/3/tv/popular?api_key=0d9b1f55e11c548f66e11f78a7f38357");
        return view;
    }
